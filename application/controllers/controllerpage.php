...
class controllerpage extends CI_Controller{
    ...
    function __construct(){
        ...
        $this->load->model('modelsmahasiswa');
    }
    ...
    function index(){
        ...
        $data['data'] = $this->modelsmahasiswa->get_mahasiswa_list($config["per_page"], $data['page']);           
    ...
    function hapus($no){
        $this->db->where('nim',$no);
        $this->db->delete('siswa');
        redirect('controllerpage/index');
    }
